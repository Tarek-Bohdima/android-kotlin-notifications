...
fun NotificationManager.sendNotification(messageBody: String, applicationContext: Context) {
    ...
    val bigPicStyle = NotificationCompat.BigPictureStyle()
        .bigPicture(eggImage)
        .bigLargeIcon(null)  //set the bigLargeIcon() to null so the large icon goes away when the notification is expanded.
    ...
    // TODO: Step 1.13 set content intent
        ...
        // To fix this, open NotificationUtils.kt and add PRIORITY_HIGH to
